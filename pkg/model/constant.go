...
// Sort functions incase I only use a subset of genome
// It does sort by creating a lookup table and custom sorting function,

// // Create a map for quick lookup of index positions
// func createIndexMap(allGenomes []string) map[string]int {
// 	indexMap := make(map[string]int)
// 	for i, genome := range allGenomes {
// 		indexMap[genome] = i
// 	}
// 	return indexMap
// }
...
// func sortSubset(subset []string, indexMap map[string]int) {
// 	sort.Slice(subset, func(i, j int) bool {
// 		return indexMap[subset[i]] < indexMap[subset[j]]
// 	})
// }
